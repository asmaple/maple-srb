package com.maple.srb.core.hfb;
...
public class HfbConst {
     ...
     * 用户绑定
     */
    public static final String ROOT_URL = "http://localhost:9990";

    //用户绑定汇付宝平台url地址
    public static final String USERBIND_URL = ROOT_URL+ "/userBind/BindAgreeUserV2";
    //用户绑定异步回调
     ...
     */
    //充值汇付宝平台url地址
    public static final String RECHARGE_URL = ROOT_URL + "/userAccount/AgreeBankCharge";
    //充值异步回调
     ...
     */
    //充值汇付宝平台url地址
    public static final String INVEST_URL = ROOT_URL + "/userInvest/AgreeUserVoteProject";
    //充值异步回调
     ...
     * 放款
     */
    public static final String MAKE_LOAD_URL = ROOT_URL + "/userInvest/AgreeAccountLendProject";

    /**
     * 提现
     */
    //充值汇付宝平台url地址
    public static final String WITHDRAW_URL = ROOT_URL + "/userAccount/CashBankManager";
    //充值异步回调
     ...
     */
    //充值汇付宝平台url地址
    public static final String BORROW_RETURN_URL = ROOT_URL + "/lendReturn/AgreeUserRepayment";
    //充值异步回调
